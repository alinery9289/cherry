...
if __name__ == '__main__':
    ...
    job = {
        'filters':[{'SimpleTranscoder':{
                ...
                'framerate:': '30',
                'bitrate': '1000k',
                'next':[{'TemplateTranscoder': {'bitrate': '40','next':{}, 'output_file_path': r'D:\\Work\\distributed_transcoder\\cherry\\video_file\\out1.mp4' }},           
                        {'TemplateTranscoder': {'bitrate': '50','next':{}, 'output_file_path': r'D:\\Work\\distributed_transcoder\\cherry\\video_file\\out2.mp4'}}] }}],
        'cache_type':'ftp',
        'is_local':0,
        # linux
